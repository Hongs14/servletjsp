...
<div class="card m-2">
   ...
   <div class="card-body">
      <a href="ParamController?pageNo=5&kind=freeboard&writer=hong&hobby=movie&hobby=game" class="btn btn-info btn-sm">GET방식으로 전달</a>
      <hr />
      <form method="post" action="ParamController" novalidate>
		...
		<div class="form-group">
         ...
         <button type="submit" class="btn btn-primary">Post방식으로 전달</button>
     </form>
     <hr/>
		...
		<form method="post" enctype="multipart/form-data" action="FileUploadController">
			...
			<button type="submit" class="btn btn-primary">Post방식/멀티파트로 전달</button>
		</form>	
   </div>
</div>
