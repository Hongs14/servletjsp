...
public class ContentController extends HttpServlet {
	...
	//load-on-startup이 있을 경우 Deployment시에 딱 한 번 실행
	//역할: service(), doGet(), doPost()에서 사용하는 데이터를 초기화해주는 역할
	@Override
	public void init(ServletConfig config) throws ServletException {
		System.out.println("exam03.ContentController.init실행");
		...
		if(config.getInitParameter("viewLocation") == null) {
			...
			encoding = config.getInitParameter("viewLoction");
		}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("exam03.ContentController.doGet실행");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("exam03.ContentController.doPost실행");
	...
	@Override
	public void destroy() {
		System.out.println("exam03.ContentController.destroy실행");
	}
}
